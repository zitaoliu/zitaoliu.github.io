...
下面主要介绍一下，我们老师发明的那个方法，穷尽搜索加减枝~还是exhaust search with pruning~听起来是不是有几分神似狂拽酷炫吊炸天的感觉~O(∩_∩)O~
...
![Longest_increasing_subsequence_problem](/images/posts/{{ page.date | date: site.date_dir_format }}/lis_tree.jpg)
